...
class Test6809_Program(BaseStackTestCase):
    ...
    def _crc16(self, data):
        ...
        self.cpu_test_run(start=0x0100, end=None, mem=[
                                     ...
                                     # 03| CRC16:
                                     # 04|    BL:
            0xA8, 0xC0,              # 05|        EORA  ,u+        ; fetch byte and XOR into CRC high byte
            0x10, 0x8E, 0x00, 0x08,  # 06|        LDY   #8         ; rotate loop counter
            0x58,                    # 07|    RL: ASLB             ; shift CRC left, first low
            0x49,                    # 08|        ROLA             ; and than high byte
            0x24, 0x04,              # 09|        BCC   cl         ; Justify or ...
            0x88, 0x10,              # 10|        EORA  #CRCH      ; CRC=CRC XOR polynomic, high
            0xC8, 0x21,              # 11|        EORB  #CRCL      ; and low byte
            0x31, 0x3F,              # 12|    CL: LEAY  -1,y       ; shift loop (8 bits)
            0x26, 0xF4,              # 13|        BNE   rl
            0x30, 0x1F,              # 14|        LEAX  -1,x       ; byte loop
            0x26, 0xEA,              # 15|        BNE   bl
        ])
...
# test(0xfffffff, 0xffff) # Error: '268435455/65535=57342 remainder:
# 57341' != '268435455/65535=4096 remainder: 4095'
